...
//        String mBaseUrl = "http://192.168.157.1:8080/FileUpload/FileUploadServlet";
//        File file = new File(Environment.getExternalStorageDirectory(), "okhttp-utils-test.mp4");
//        File file2 = new File(Environment.getExternalStorageDirectory(), "lower.txt");
...
//        params.put("username", "张小黑");
//        params.put("password", "123456");
//
//        String url = mBaseUrl ;
//        OkHttpUtils.post()//
//                .addFile("mFile", "server_okhttp-utils-test.mp4", file)//
//                .addFile("mFile", "server_lower.txt", file2)//
//                .url(url)
//                .params(params)//
//                .build()//
